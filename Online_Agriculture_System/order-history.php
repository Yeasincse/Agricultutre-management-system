...
<html lang="en">
	<head>
	    ...
	    <title> Online Agriculture System  | Order History</title>
...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Online_Agriculture_System/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
